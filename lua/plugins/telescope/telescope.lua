...
local grep_exclusions_hidden = function()
  return {
    table.unpack(grep_exclusions_normal()),
    "--hidden",
    "--glob=!.git/*"
  }
end
    ...
    keys = function()
      ...
      return {
        ...
        -- Fast file search variants (no preview)
        {
          "<leader>fnf",
          function()
            builtin.find_files(vim.tbl_extend("force", dropdown_theme, { no_ignore = false }))
          end,
        ...
        },
        {
          "<leader>Fnf",
          function()
            builtin.find_files(vim.tbl_extend("force", dropdown_theme, { cwd = "~" }))
          end,
        ...
        },
        {
          "<leader>fnF",
          function()
            builtin.find_files(vim.tbl_extend("force", dropdown_theme, { hidden = true }))
          end,
        ...
        },
        {
          "<leader>fn+",
          function()
            builtin.find_files(vim.tbl_extend("force", dropdown_theme, { hidden = true, no_ignore = true }))
          end,
        ...
        },
        {
          "<leader>FnF",
          function()
            builtin.find_files(vim.tbl_extend("force", dropdown_theme, { cwd = "~", hidden = true }))
          end,
        ...
        -- Fast grep search variants (no preview)
        {
          "<leader>fng",
          function()
            builtin.live_grep(vim.tbl_extend("force", dropdown_theme, {
              additional_args = grep_exclusions_normal
            }))
          end,
        ...
        -- Fast Neovim config files (no preview)
        {
          "<leader>Fnn",
          function()
            builtin.find_files(vim.tbl_extend("force", dropdown_theme, {
